                    ...
                    {filteredBarangList.length > 0 ? (
                        filteredBarangList.map((b, index) => (
                            <tr key={b.id}>
                                ...
                                {/* <td>
                                    <img
                                        src={`https://www.p3l.reusemart.fun/${b.gambar}`}
                                        alt={b.nama_barang}
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-3">
                                    {isEdit && form.gambar_lama && (
                                        <div className="mb-2">
                                            <img
                                                src={`https://www.p3l.reusemart.fun/${form.gambar_lama}`}
                                                alt="Gambar Lama"
                                                className="img-thumbnail"
                                                style={{ width: "100px", height: "100px", objectFit: "cover" }}
                                            />
                                ...
                                <div className="mb-3">
                                    {isEdit && form.gambar_dua_lama && (
                                        <div className="mb-2">
                                            <img
                                                src={`https://www.p3l.reusemart.fun/${form.gambar_dua_lama}`}
                                                alt="Gambar 2 Lama"
                                                className="img-thumbnail"
                                                style={{ width: "100px", height: "100px", objectFit: "cover" }}
                                            />
                                        ...
                                        <div id="carouselGambar" className="carousel slide" data-bs-ride="carousel">
                                            <div className="carousel-inner">
                                                <div className="carousel-item active">
                                                    <img
                                                        src={`https://www.p3l.reusemart.fun/${selectedBarang.gambar}`}
                                                ...
                                                {selectedBarang.gambar_dua && (
                                                    <div className="carousel-item">
                                                        <img
                                                            src={`https://www.p3l.reusemart.fun/${selectedBarang.gambar_dua}`}
                                                            className="d-block w-100 rounded"
                                                            alt="Gambar 2"
                                                            style={{ maxHeight: "300px", objectFit: "contain" }}
                                                        />
