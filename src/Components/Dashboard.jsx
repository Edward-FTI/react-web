...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchBarang = async () => {
      try {
        const response = await axios.get("https://103.175.219.103/api/barang");
        ...
        <div className="row row-cols-1 row-cols-md-5 g-2">
          {barang.map((item) => (
            <div className="col" key={item.id}>
              ...
              >
                <img
                  src={`https://103.175.219.103/${item.gambar}`}
                  ...
                  >
                    <div className="carousel-inner border rounded">
                      {selectedBarang.gambar_array?.map((gambar, index) => (
                        ...
                        >
                          <img
                            src={`https://103.175.219.103:8000/${gambar}`}
            ...
            <ul className="list-group">
              {cartItems.map((item) => (
                ...
                >
                  <div className="d-flex align-items-center">
                    <img
                      src={`https://103.175.219.103/${item.barang.gambar}`}
